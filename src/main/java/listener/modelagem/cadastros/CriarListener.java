...
public class CriarListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            daoUtil.insert(String.format("INSERT INTO CAMPOSCADASTROS (idcadastro, ordem, label, coluna, tipo, vinculado, bloqueado, obrigatorio, nativo, ordemagrupador) VALUES (%d, 1, 'ID', 'id', 'Numérico', false, false, false, true, 0)", cadastroId));
            daoUtil.insert(String.format("INSERT INTO CAMPOSCADASTROS (idcadastro, ordem, label, coluna, tipo, vinculado, bloqueado, obrigatorio, nativo, ordemagrupador) VALUES (%d, 2, 'Registrado em', 'registrado_em', 'Data hora', false, false, false, true, 0)", cadastroId));
            daoUtil.insert(String.format("INSERT INTO CAMPOSCADASTROS (idcadastro, ordem, label, coluna, tipo, vinculado, bloqueado, obrigatorio, nativo, ordemagrupador) VALUES (%d, 3, 'Registrado por', 'registrado_por', 'Numérico', false, false, false, true, 0)", cadastroId));
            daoUtil.insert(String.format("INSERT INTO CAMPOSCADASTROS (idcadastro, ordem, label, coluna, tipo, vinculado, bloqueado, obrigatorio, nativo, ordemagrupador) VALUES (%d, 4, 'Última atualização', 'ultima_atualizacao', 'Data hora', false, false, false, true, 0)", cadastroId));
            daoUtil.insert(String.format("INSERT INTO CAMPOSCADASTROS (idcadastro, ordem, label, coluna, tipo, vinculado, bloqueado, obrigatorio, nativo, ordemagrupador) VALUES (%d, 5, 'Atualizado por', 'atualizado_por', 'Numérico', false, false, false, true, 0)", cadastroId));
